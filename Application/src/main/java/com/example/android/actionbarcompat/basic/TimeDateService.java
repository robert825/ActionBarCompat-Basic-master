...
public class TimeDateService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Log.i("InClassExample", "Service Binded");
        return null;
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("InClassExample", "Service onStart");
    ...
    public void onCreate() {
        Log.i("InClassExample", "Service onCreate");
    }

    @Override
    public void onDestroy() {
        Toast.makeText(this, "Service Stopped", Toast.LENGTH_SHORT).show();
        Log.i("InClassExample", "Service onDestroy");
        _shutdownService();
    ...
    private void _shutdownService() {
        mHandler.removeCallbacks(mUpdateTimeTask);
        Log.i("InClassExample", "Timer stopped...");
    }
